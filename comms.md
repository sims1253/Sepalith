...
| zcode-cma-poc | decay/CMA + MuonH POC (`2026-08-28-decay-cma-muonh-poc-plan.md`) — Tasks 0-2 done; Task 4 arm matrix RUNNING; Tasks 5-8 next | this session (successor of sess_zcode_cma, died on usage limit 2026-08-30; chain survived detached) | active — arm matrix in flight |
