...
| zcode-cma-poc | decay/CMA + MuonH POC (`2026-08-28-decay-cma-muonh-poc-plan.md`) — Tasks 0,1,3 CPU now; Tasks 2,4+ queued for GPU behind zcode-stabtok's P1 chain | sess_zcode_cma (2026-08-29) | active — Task 0/1 CPU prep in progress |
