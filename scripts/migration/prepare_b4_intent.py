...
def main():
    ...
    includes = ['packages/sepalith/src', 'experiments/eval/run_intent_suite.py',
        ...
        'scripts/migration/b4_intent.py', 'scripts/migration/v1c_artifacts.py']
    recipe = dict(schema_version=1, id='b4-intent-' + a.phase + '-20260908',
        ...
        provenance=dict(queue_item='S2/production quant intent', phase=a.phase,
            ...
            pi_review='Both max/120s: Muse completed 47.17s; GLM timeout 120.02s. Separate generation, strict calibration, exact judge-body cache.',
    ...
    for action, artifacts in actions:
        recipe['steps'].append(dict(id=action, argv=['{python}', '{source}/scripts/migration/b4_intent.py',
