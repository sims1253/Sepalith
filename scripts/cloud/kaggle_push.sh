...
# 1) repo tarball -> private dataset m0hawk/sepalith-repo (12MB; version up)
TARBALL="sepalith-repo-$SHA.tar.gz"
...
echo "repo staged: m0hawk/sepalith-repo @ $SHA ($TARBALL)"
...
src = sorted(glob.glob("/kaggle/input/sepalith-repo/*.tar.gz"))[-1]
dst = "/kaggle/working/Sepalith"
os.makedirs(dst, exist_ok=True)
print("bootstrap: extracting", src, flush=True)
