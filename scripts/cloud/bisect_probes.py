...
P2_PREAMBLE = (
    ...
    "def _fp32_init(self, *args, **kwargs):\n"
    "    _m = kwargs.get('model') or (args[1] if len(args) > 1 else None)\n"
    "    if _m is not None:\n"
    "        try:\n"
    "            _m.float()\n"
    "            import torch\n"
    ...
    "        except Exception as _e:\n"
    "            print(f'BISECT-P2: coerce failed: {_e}', flush=True)\n"
    "    _orig_init(self, *args, **kwargs)\n"
    "transformers.Trainer.__init__ = _fp32_init\n"
)
